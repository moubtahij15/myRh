package com.example.recrutementbackend.Security;
...
//    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeRequests(auth -> auth.requestMatchers("/token/**", "/inscription/**", "/verify/**", "/download/**", "/resend/**", "/offer/valider","/profiles/**","/searchOffre").permitAll())
